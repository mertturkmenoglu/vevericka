...
const styles = clsx(
  'first-letter:text-7xl first-letter:font-bold first-letter:text-primary first-letter:mr-3 first-letter:float-left',
  'sm:w-2/3 list-disc ml-2 sm:ml-16 my-16'
);
...
export const getServerSideProps: GetServerSideProps<PlaylistPageProps> = async (context) => {
  ...
  const latest = await blogApi.getPlaylist(yearNumber, monthNumber);
