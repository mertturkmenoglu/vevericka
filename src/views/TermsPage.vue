  ...
  <v-container>
    <v-card flat outlined>
      ...
      <v-card-text>
        ...
        <h3>Accounts</h3>
        <div>When you create an account with us, you <b>guarantee</b> that you are above the age of 18, or a Your legal guardian or Your parent gives consent, and that the information you provide us is <b>accurate, complete, and current</b> at all times.</div>
        <p>Inaccurate, incomplete, or obsolete information <b>may result in the immediate termination</b> of your account on the Service.</p>
        <div>You are <b>responsible</b> for maintaining the confidentiality of your <b>account and password</b>, including but not limited to the restriction of access to your computer and/or account.</div>
        <div>You agree to <b>accept responsibility for any and all activities or actions</b> that occur under your account and/or password, whether your password is with our Service or a third-party service.</div>
        <p>You must <b>notify us immediately</b> upon becoming aware of <b>any breach of security or unauthorized use of your account.</b></p>

        <h3>Cookies, Tracking, GDPR</h3>
        ...
        <p>
          <b> a) your use and access of the Service, by you or any person using your account and password, or </b>
        </p>
        <p>
          <b>b) a breach of these Terms.</b>
        </p>
        ...
        <p>
          <b>(ii) any conduct or content of any third party on the Service;</b>
        </p>

        <p>
          <b>(iii) any content obtained from the Service; and</b>
        </p>

        <p>
          <b>(iv) unauthorized access, use or alteration of your transmissions or content, whether based on warranty,
            ...
            and even if a remedy set forth herein is found to have failed of its essential purpose.</b>
        </p>
        ...
        <p><b>Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.</b></p>
        ...
        <p><b>These Terms constitute the entire agreement between us regarding our Service, and supersede and replace any prior agreements we might have had between us regarding the Service.</b></p>

        <h3>Changes</h3>
        <div>We reserve the right, at our sole discretion, to modify or replace these Terms at any time.</div>
        <div>If a revision is material we will provide <b>at least 30 days notice prior</b> to any new terms taking effect.</div>
        <p>What constitutes a material change will be determined at our sole discretion.</p>

        <p>By continuing to access or use our Service after any revisions become effective, <b>you agree to be bound by the revised terms</b>.</p>
        <p>If you do not agree to the new terms, you are no longer authorized to use the Service.</p>

        <h3>Contact Us</h3>
        <p><b>If you have any questions about these Terms, please contact: {{ contactEmail }}</b></p>
      </v-card-text>
    </v-card>
  </v-container>
</template>
