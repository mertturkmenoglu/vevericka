  ...
  <v-card flat>
    ...
    <v-container>
      ...
      >
        ...
        <a
          class="my-1 pt-1 em-08 deep-orange--text"
          :href="user.website"
        >{{ user.website }}</a>
      </v-row>
      <v-row
      ...
      <v-row v-if="noInfo">
        <div class="em-08 text-center font-weight-light mt-3 text--primary">
          No Information
        </div>
      </v-row>
    </v-container>
