  ...
  return (
    <div className="h-screen overflow-y-auto">
      <div className="flex h-full flex-col lg:flex-row">
        ...
        <div className="flex w-full flex-col items-center justify-center bg-white dark:bg-neutral-800 lg:w-4/12">
          <div className="mb-16 flex w-3/4 flex-col items-center justify-center bg-white text-primary dark:bg-neutral-800 md:w-2/4 lg:mb-0 lg:w-3/4 xl:w-2/4">
            <h3 className="mt-16 text-2xl font-normal text-midnight dark:text-primary sm:text-3xl lg:mt-0">
              {formTitle}
            </h3>
            {children}
          </div>
