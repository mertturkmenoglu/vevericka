...
function LandingAppBar({ className }: LandingAppBarProps): JSX.Element {
  return (
    <nav
      className={clsx(
        'container mx-auto flex items-center justify-between rounded-full bg-zinc-100 px-8 py-2 dark:bg-neutral-800',
        className
      )}
    >
      <div className="flex items-center space-x-8">
        <SquirrelLogo
          ...
          viewBox="0 0 512 512"
        />
        <h2 className="hidden text-lg text-midnight dark:text-white sm:flex">Vevericka</h2>
      </div>
