...
export type FeedQueryQuery = { __typename?: 'Query', feed: { __typename?: 'Feed', posts: Array<{ __typename?: 'Post', id: number, content: string, createdAt: any, updatedAt: any, user: (
        { __typename?: 'User' }
